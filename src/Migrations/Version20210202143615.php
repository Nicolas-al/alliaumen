 ...
 */
final class Version20210202143615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skills ADD percent INT NOT NULL, ADD color VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skills DROP percent, DROP color');
    }
}
