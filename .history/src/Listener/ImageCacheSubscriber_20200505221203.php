...
class ImageCacheSubscriber implements EventSubscriber
{
    ...
    public function preUpdate(PreUpdateEventArgs $args)
    {
        ...
        if ($entity instanceof Portfolio)
        {
            ...
            {
                $this->cacheManager->remove($this->uploaderHelper->asset($entity, fieldName 'imagefile'))
            }
        }
        if ($entity instanceof Skills)
        {
            if ($entity->getImageFile() instanceof UploaderHelper)
            {
                $this->cacheManager->remove($this->uploaderHelper->asset($entity, fieldName 'logofile'))
            }
        }
